...
public enum LockType {
    ...
    public static boolean compatible(LockType a, LockType b) {
        ...
        // Follow disc8 compatibility matrix
        switch (a) {
            case S: return b == S || b == IS || b == NL;
            case X: return b == NL;
            case IS: return b != X;
    ...
    public static boolean canBeParentLock(LockType parentLockType, LockType childLockType) {
        ...
        // TODO(proj4_part1): implement
        if (parentLockType == childLockType || childLockType == NL) {return true;}
        switch (parentLockType) {
            case IS: return childLockType == S;
            case IX: return childLockType == X || childLockType == S || childLockType == IS || childLockType == SIX;
