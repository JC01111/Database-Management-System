    ...
    private class BNLJIterator implements Iterator<Record>{
        ...
        private void fetchNextLeftBlock() {
            ...
            if (leftSourceIterator.hasNext()) {
                ...
                leftRecord = leftBlockIterator.next();  // Fetch the next block of records
            } else {
                return;
            }
        }
        ...
        private Record fetchNextRecord() {
            ...
            while (true) {
                ...
                // Case 2: The right page iterator doesn't have a value to yield but the left block iterator does
                    ...
                    leftRecord = leftBlockIterator.next();  // Fetch the left block iterator value
                    rightPageIterator.reset();  // Reset the rightPageIterator to compare with the left blocks
                }
